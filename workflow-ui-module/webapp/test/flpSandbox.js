		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#workflowmanagementworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workflowmanagementworkflowuimodule-display": {
								"semanticObject": "workflowmanagementworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workflowmanagement.workflowuimodule",
									"url": sap.ui.require.toUrl("workflowmanagement/workflowuimodule")
								}
							}
						}
					}
